...
export default class TestTask extends NavigationMixin(LightningElement) {
    isModalOpen = false;
    @track recordTypes = [];
    @track value;
    @track error;
    ...
    // Wire method to get object names
    ...
    // Wire method to get the most recent auto number
    ...
    // Fetch object API name and record types
    ...
    // Fetch record types based on the object API name
    ...
    // Show modal when action button is clicked
    connectedCallback() {
        // This is for when the component is placed on an action button
    ...
    // Save Task Configuration and create Task
    handleSave() {
    ...
    // Navigate to the newly created Task Configuration record
